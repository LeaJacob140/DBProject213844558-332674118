...
prompt Created on שבת 20 יולי 2024 by מוריה חדד
set feedback off
set define off
...
prompt Creating DEBRIFIED...
create table DEBRIFIED
(
  evid  INTEGER not null,
  debid INTEGER not null
)
...
alter table DEBRIFIED
  add primary key (EVID, DEBID)
  using index 
  tablespace SYSTEM
  pctfree 10
  initrans 2
...
prompt Creating REPORTSIN...
create table REPORTSIN
(
  boid  INTEGER not null,
  debid INTEGER not null
)
...
alter table REPORTSIN
  add primary key (BOID, DEBID)
  using index 
  tablespace SYSTEM
  pctfree 10
  initrans 2
...
prompt Disabling triggers for DEBRIFIED...
alter table DEBRIFIED disable all triggers;
...
prompt Disabling triggers for REPORTSIN...
alter table REPORTSIN disable all triggers;
...
prompt Disabling foreign key constraints for DEBRIFIED...
alter table DEBRIFIED disable constraint SYS_C009194;
alter table DEBRIFIED disable constraint SYS_C009195;
...
prompt Disabling foreign key constraints for REPORTSIN...
alter table REPORTSIN disable constraint SYS_C009197;
alter table REPORTSIN disable constraint SYS_C009198;
...
commit;
prompt Deleting REPORTSIN...
delete from REPORTSIN;
commit;
...
delete from DONOR;
commit;
prompt Deleting DEBRIFIED...
delete from DEBRIFIED;
commit;
...
insert into DONATION (itemid, donorid)
values (19, 199);
insert into DONATION (itemid, donorid)
values (19, 199);
insert into DONATION (itemid, donorid)
...
prompt Enabling foreign key constraints for DEBRIFIED...
alter table DEBRIFIED enable constraint SYS_C009194;
alter table DEBRIFIED enable constraint SYS_C009195;
...
prompt Enabling foreign key constraints for REPORTSIN...
alter table REPORTSIN enable constraint SYS_C009197;
alter table REPORTSIN enable constraint SYS_C009198;
...
prompt Enabling triggers for DEBRIFIED...
alter table DEBRIFIED enable all triggers;
...
prompt Enabling triggers for REPORTSIN...
alter table REPORTSIN enable all triggers;
