...
CREATE TABLE MainTenan (
    ...
    itemId INT,
    FOREIGN KEY (idmaintenance) REFERENCES MAINTENANCE(MAINTENANCEID),
...
---taking the data from donation
INSERT INTO DONERTO (DONATIONID, DONATIONDATE)
SELECT DONATIONID, DONATIONDATE
FROM DONATION;
---deleting the donatoindate and donationid from donation
ALTER TABLE DONATION DROP COLUMN DONATIONID;
